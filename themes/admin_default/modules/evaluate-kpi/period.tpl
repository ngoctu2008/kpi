    ...
    <table class="table table-striped table-bordered table-hover">
        <thead>
            <tr>
                ...
                <th class="text-center">Hạn chót (Lock form)</th>
                <th>{LANG.status}</th>
    ...
    <div class="panel-body">
        <form action="{NV_BASE_ADMINURL}index.php?{NV_LANG_VARIABLE}={NV_LANG_DATA}&amp;{NV_NAME_VARIABLE}={MODULE_NAME}&amp;{NV_OP_VARIABLE}={OP}" method="post">
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="text" name="title" value="{ROW.title}" required="required" placeholder="VD: Đánh giá KPI Tháng 01/2024" />
            </div>
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-4">
                    <div class="form-group">
                        <label><strong>Hạn chót nộp (Lock)</strong></label>
                        <div class="input-group">
